        ...
        win.document.write(`
            ...
            <head>
                ...
                <style>
                    ...
                    textarea { width: 100%; background: #111; font-family: Consolas, monospace; font-size: 13px; border: 1px solid #444; padding: 10px; margin-bottom: 15px; box-sizing: border-box; border-radius: 4px; resize: vertical; line-height: 1.4; outline: none; }
                    
                    /* Theme Viewer Styling */
                    #theme-area { height: 200px; color: #888; background: #0a0a0a; border-color: #222; }
                    #css-area { height: 250px; color: #0f0; border-color: #050; }
                    #js-area { height: 100px; color: #ff0; }
            ...
            <body>
                ...
                <label>Active Base Theme (Read-Only Source):</label>
