...
log('INFO', 'Loading Professional Native Window Editor...');
...
function injectEditor() {
    ...
    openBtn.className = 'cssokoun-btn cssokoun-btn-primary';
    openBtn.innerHTML = '🪟 Open Code Editor';
    ...
    openBtn.addEventListener('click', () => {
        ...
        win.document.write(`
            ...
            <head>
                ...
                <style>
                    :root {
                        --cso-bg-base: #1e1e1e; --cso-bg-panel: #252526; --cso-bg-input: #1e1e1e;
                    ...
                    ::-webkit-scrollbar-track { background: var(--cso-bg-base); }
                    ::-webkit-scrollbar-thumb { background: var(--cso-border); border-radius: 5px; border: 2px solid var(--cso-bg-base); }
                    ...
                    textarea { 
                        width: 100%; background: var(--cso-bg-input); font-family: var(--cso-font-mono); font-size: 13px; 
                        border: 1px solid var(--cso-border); padding: 12px; margin-bottom: 15px; box-sizing: border-box; 
                        border-radius: 4px; resize: vertical; line-height: 1.5; outline: none; transition: border-color 0.2s;
                    }
                    ...
                    button { border: none; padding: 10px 14px; cursor: pointer; border-radius: 4px; font-weight: 600; font-size: 13px; color: #fff; transition: background 0.2s; font-family: var(--cso-font-sans); display: flex; align-items: center; justify-content: center; gap: 6px; }
